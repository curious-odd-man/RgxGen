...
public class PathGraph {
    ...
    public List<PathGraphCluster> getRootClusters() {
        return Collections.unmodifiableList(rootClusters);
    }
    ...
    private static String edgeDeclaration(PathEdge edge) {
        String from = "node_" + edge.getFrom().getId();
        String to = "node_" + edge.getTo().getId();
