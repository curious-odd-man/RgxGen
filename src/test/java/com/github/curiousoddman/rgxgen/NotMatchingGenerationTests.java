...
public class NotMatchingGenerationTests {
    ...
    private static Collection<Object[]> initialData() {
        return Arrays.asList(new Object[][]{
                {"[a-z0-5]", new SymbolSet("[a-z0-5]", Arrays.asList(SymbolRange.of('a', 'z'), SymbolRange.of('0', '5')), MatchType.POSITIVE)},
                ...
                {"a[a-z]", new Sequence("a[a-z]", new FinalSymbol("a"),
                                        new SymbolSet("[a-z]", Collections.singletonList(SymbolRange.of('a', 'z')), MatchType.POSITIVE))},
