...
public class NotMatchingGenerationTests {
    ...
    private static Collection<Object[]> initialData() {
        return Arrays.asList(new Object[][]{
                {"[a-z0-5]", SymbolSet.ofAsciiRanges("[a-z0-5]", Arrays.asList(SymbolRange.symbols('a', 'z'), SymbolRange.symbols('0', '5')), MatchType.POSITIVE)},
                ...
                {"a[a-z]", new Sequence("a[a-z]", new FinalSymbol("a"),
                                        SymbolSet.ofAsciiRanges("[a-z]", Collections.singletonList(SymbolRange.symbols('a', 'z')), MatchType.POSITIVE))},
    ...
    public void nodeVisitingWorksTest(String pattern, Node expectedNode, int seed) {
        NodeTreeBuilder builder = new DefaultTreeBuilder(pattern);
