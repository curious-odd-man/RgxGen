...
public class UtilTests {
    ...
    void textVariationsTest() {
        ...
        Set<String> strings = makeVariations(
                Arrays.asList("L", "Spacing_Combining_Mark"),
                '_',
                '-', ' '
        );

        Set<String> expected = new HashSet<>(Arrays.asList("Spacing_Combining_Mark", "Spacing-Combining-Mark", "L", "Spacing Combining Mark"));
